...
# vLLM LoRA internals changed across versions.
# - vLLM<=0.13: `vllm.lora.models.LoRAModel`
# - vLLM>=0.14: `vllm.lora.lora_model.LoRAModel`
try:
    from vllm.lora.lora_model import LoRAModel  # vLLM >= 0.14
except ModuleNotFoundError:  # pragma: no cover - older vLLM
    from vllm.lora.models import LoRAModel  # type: ignore[attr-defined]  # vLLM <= 0.13
